...
// console.log(orderedAlbums)
  ...
  export const mayAlbums = albums.filter(album => album.month === "may")
  export const juneAlbums = albums.filter(album => album.month === "june")
  export const julyAlbums = albums.filter(album => album.month === "july")
  export const augustAlbums = albums.filter(album => album.month === "august")
